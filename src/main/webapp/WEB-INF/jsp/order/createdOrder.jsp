                    ...
                    <div class="sync-order-cart-main">
                        ...
                        <div class="order-dish-option">
                            ...
                            <div class="cart-ordered-list">
                                <c:forEach items="${detailList}" var="detail">
                                    <div class="cart-ordered-dish">
                                        <div class="ordered-dish">
                                            <span class="dish-name">${detail.}</span>
                                            <span class="dish-price price ellipsis">29</span>
                                            <div class="counter">
                                ...
                                <div class="cart-ordered-dish">
                                    <div class="ordered-dish">
                                        <span class="dish-name">五谷杂粮（特价）</span>
                                        <span class="dish-price price ellipsis">29</span>
                                        <div class="counter">
                                            <span class="counter-num" style="min-width: 35px; z-index: 11;">
                                            共 1 份
                                ...
                                <div class="cart-ordered-dish">
                                    <div class="ordered-dish">
                                        ...
                                        <div class="counter">
                                            <span class="counter-num" style="min-width: 35px; z-index: 11;">共 1 份</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cart-ordered-dish">
                                    <div class="ordered-dish">
                                        <span class="dish-name">特价十三香龙虾（三斤）</span>
                                        <span class="dish-price price ellipsis">100</span>
                                        <div class="counter">
                                            <span class="counter-num"
                                                  style="min-width: 35px; z-index: 11;">共 1 份</span>
                                        </div>
                                    </div>
                                </div>
